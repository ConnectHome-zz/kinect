...
std::string createInitGestureXml()
{
	...
	msg->append_node(createNode(document, "ID", emptyMap, "1"));
	msg->append_node(createNode(document, "nameP", emptyMap, "Kinect"));
	msg->append_node(createNode(document, "descP", emptyMap, "Movement controller, do a wave with your hand to start a movement"));
	...
	mov1->append_node(createNode(document, "movID", emptyMap, "2"));
	mov1->append_node(createNode(document, "nameM", emptyMap, "Swipe Left"));
	mov1->append_node(createNode(document, "descM", emptyMap, "Do a swipe to the left"));
	...
	mov2->append_node(createNode(document, "movID", emptyMap, "1"));
	mov2->append_node(createNode(document, "nameM", emptyMap, "Swipe Right"));
	mov2->append_node(createNode(document, "descM", emptyMap, "Do a swipe to the right"));
	...
	mov3->append_node(createNode(document, "nameM", emptyMap, "Push"));
	mov3->append_node(createNode(document, "descM", emptyMap, "Move your hand to Kinect"));
